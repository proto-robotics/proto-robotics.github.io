export class State {
     ...
     */
    hover(line, column) {
        const ret = wasm.state_hover(this.__wbg_ptr, line, column);
        return ret;
    }
    /**
     * @returns {any}
    ...
    semanticTokens(range) {
        const ret = wasm.state_semanticTokens(this.__wbg_ptr, range);
        return ret;
    }
    /**
     * @returns {any}
    ...
    semanticTokensLegend() {
        const ret = wasm.state_semanticTokensLegend(this.__wbg_ptr);
        return ret;
    }
    /**
     ...
     */
    updateSandboxFiles(files, force_update) {
        const ret = wasm.state_updateSandboxFiles(this.__wbg_ptr, files, force_update);
        if (ret[3]) {
